...
export const putSaldoAFavorFacturas = async (factura) => {
  return await post(`facturacion/update_saldo_favor`, {
    Id_Monto: factura.Id_Monto,
    Id_Factura: factura.Id_Factura,
    Monto: Number(factura.Monto),
    Cedula: factura.Cedula,
  });
...
export const putDepositoFacturas = async (factura) => {
  return await post(`facturacion/update_deposito`, {
    Id_Deposito: factura.Id_Deposito,
    Id_Factura: Number(factura.Id_Factura),
    Id_Banco: Number(factura.Id_Banco),
    Referencia: factura.Referencia,
    Monto: Number(factura.Monto),
