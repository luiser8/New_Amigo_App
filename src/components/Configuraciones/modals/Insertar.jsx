...
const Insertar = ({ openInsert, roles, confirm }) => {
                    ...
                    >
                        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                ...
                                                <div className="px-4 py-2 bg-white ">
                                                    <div className="grid grid-cols-10 gap-4">
                                                        ...
                                                        <div className="col-span-5">
                                                            ...
                                                            <input id="cedula" name="cedula" onChange={async (ev) => setCedula(ev.target.value)} type="text" required className="mt-1 block w-full py-2 px-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Cédula" />
                                                        </div>
                                                        <div className="col-span-5">
                                                        ...
                                                        <div className="col-span-5">
                                                            ...
                                                            <input id="usuario" name="usuario" onChange={async (ev) => setUsuario(ev.target.value)} type="text" required className="mt-1 block w-full py-2 px-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Usuario" />
                                                        </div>
                                                        <div className="col-span-5">
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    type="button"
                                    disabled={rolId !== '' && cedula !== 0 && nombres !== '' && apellidos !== '' && usuario !== '' && contrasena !== '' ? false : true}
                                    className={`${rolId !== '' && cedula !== 0 && nombres !== '' && apellidos !== '' && usuario !== '' && contrasena !== '' ? 'bg-green-600 hover:bg-green-700' : 'bg-green-200 hover:bg-green-200'} w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2  text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm`}
