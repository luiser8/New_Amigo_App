...
const ModificarCedula = ({ openC, confirm, CedulaOld }) => {
    const cancelButtonRef = useRef(null);
    const [open, setOpen] = useState(true);
    const [cedula, setCedula] = useState(CedulaOld);

    const activeModificacionCedula = (open) => {
        openC(open); setOpen(open);
    }

    const okModificarCedula = async () => {
        confirm({ 'Cedula': cedula }); setOpen(open);
    }
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog
                ...
                open={open}
                onClose={() => activeModificacionCedula(false)}
            >
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                                            Modificar Cédula <span style={{ color: 'red' }}>{CedulaOld}</span>
                                        </Dialog.Title>
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Asegúrate de colocar el número de cédula correctamente.
                                            </p>
                                        </div>
                                                ...
                                                <div className="px-4 py-5 bg-white sm:p-6">
                                                    <div className="grid grid-cols-4">
                                                        <div className="col-span-6 sm:col-span-3">
                                                            <label htmlFor="first-name" className="block text-sm font-medium text-gray-700">Cédula nueva</label>
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    onClick={() => okModificarCedula(true)}
                                >
                                    Guardar
                                </button>
                                <button
                                    ...
                                    onClick={() => activeModificacionCedula(false)}
                                    ref={cancelButtonRef}
                                >
                                    Cancelar
                                </button>
...
ModificarCedula.propTypes = {
    openC : PropTypes.func,
    confirm : PropTypes.func,
    CedulaOld : PropTypes.string,
}
export default ModificarCedula;