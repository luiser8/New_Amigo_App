                                ...
                                <div className="md:grid md:grid-cols-3 md:gap-6">
                                    <div className="md:col-span-1">
                                        <div className="px-4 sm:px-0">
                                            ...
                                            <p className="mt-1 text-sm text-gray-600">Generación de reporte de inscripciones de estudiantes por lapso, tipo de inscripciòn</p>
                                        </div>
                                    </div>
                                                ...
                                                <div className="px-4 py-5 bg-white sm:p-6">
                                                    <div className="grid grid-cols-8 gap-6">
                                                        ...
                                                        <div className="col-span-2">
                                                            <button
                                                                type="button"
                                                                onClick={(ev) => getReporte(ev)}
                                                                disabled={(Object.keys(menus).length !== 0) ? false : true}
                                                                className={`inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white ${(Object.keys(menus).length === 0) ? 'bg-indigo-200 hover:bg-indigo-200' : 'bg-indigo-600 hover:bg-indigo-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
                                                            >
                                                                Generar reporte
                                                            </button>
                                                        </div>
