                ...
                <div className="px-4 py-2 bg-white sm:p-6">
                  <div className="grid grid-cols-8 gap-6">
                    ...
                    <div className="col-span-2 sm:col-span-2 mx-4">
                      <button
                        type="button"
                        className="inline-flex items-center mx-2 px-2 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        ...
                        <tr key={key}>
                          ...
                          <td
                            className={`px-2 py-4 whitespace-nowrap text-sm text-gray-500 ${
                              item.Cerrado === 0 ? "bg-green-100" : "bg-red-100"
                            }`}
                          >{`${item.Cerrado === 0 ? "No" : "Si"}`}</td>
