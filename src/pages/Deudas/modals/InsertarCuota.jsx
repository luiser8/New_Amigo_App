  ...
  const okInsertar = async () => {
    if (
      ...
      confirm({
        ...
        Monto: cuota,
        FechaVencimiento: Moment(fechaVencimiento, "YYYY-MM-DD").format(
          "YYYY-MM-DD",
        ),
      });
    }
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    >
                      Insertar arancel{" "}
                      <span style={{ color: "red" }}>Lapso {checkLapso()}</span>
                    </Dialog.Title>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Asegúrate de primero crear la cuota correspondiente y
                        luego realizas la eliminación de dicha cuota.
                      </p>
                    </div>
                            ...
                            <div className="col-span-6 sm:col-span-4">
                              ...
                              <select
                                ...
                                onChange={async (event) =>
                                  changeArancelFecha(Number(event.target.value))
                                }
                              >
                                ...
                                {Object.keys(aranceles_list).map((key, it) => (
                                  <option
                                    key={key}
                                    value={`${aranceles_list[it].Id_Arancel}`}
                                  >
                                    {aranceles_list[it].Descripcion} -{" "}
                                    {Moment(
                                      aranceles_list[it].FechaVencimiento,
                                      "YYYY-MM-DD",
                                    ).format("YYYY-MM-DD")}
                                  </option>
                                ))}
