...
const Error = () => {
    ...
    return (
        <div className="bg-gray-100">
            <div className="h-screen w-screen flex flex-wrap justify-center content-center items-center absolute z-0">
            ...
            <div className="h-screen w-screen flex flex-wrap justify-center content-end md:content-center items-end md:items-center relative z-10">
                <div className="p-6 text-center ">
                    ...
                    <p className="mt-3 uppercase text-sm lg:text-base text-gray-900">The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
                    <a href="/" className="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-2xl">Back To Homepage</a>
                </div>
            </div>
        </div>
    );
