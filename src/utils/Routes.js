...
import Facturacion from "../pages/Facturas/Facturacion";
  ...
  return useRoutes([
    {
      ...
      element:
        checkUser().UsuarioId !== null ? (
          <Deudas user={checkUser().UsuarioId} />
        ) : (
          <Login />
        ),
    },
    {
      path: "/actualizar",
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Actualizar user={checkUser().UsuarioId} />
        ) : (
          <Login />
        ),
    },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Facturacion user={checkUser().UsuarioId} type={1} />
        ) : (
          <Login />
        ),
    },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Reportes user={checkUser().UsuarioId} type={1} />
        ) : (
          <Login />
        ),
    },
    ...
    // },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Reportes user={checkUser().UsuarioId} type={3} />
        ) : (
          <Login />
        ),
    },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Insertar user={checkUser().UsuarioId} />
        ) : (
          <Login />
        ),
    },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Configuracion user={checkUser().UsuarioId} />
        ) : (
          <Login />
        ),
    },
    {
      ...
      element:
        checkUser().UsuarioId !== null && checkUser().Rol !== "6" ? (
          <Reset user={checkUser().UsuarioId} />
        ) : (
          <Login />
        ),
    },
